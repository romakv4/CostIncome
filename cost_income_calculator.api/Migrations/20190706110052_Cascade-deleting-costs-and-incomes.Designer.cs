...
namespace cost_income_calculator.api.Migrations
{
    ...
    [Migration("20190706110052_Cascade-deleting-costs-and-incomes")]
    partial class Cascadedeletingcostsandincomes
    {
            ...
            modelBuilder.Entity("cost_income_calculator.api.Models.Cost", b =>
                {
                    b.HasOne("cost_income_calculator.api.User", "user")
                        .WithOne("Cost")
                        .HasForeignKey("cost_income_calculator.api.Models.Cost", "UserId")
            ...
            modelBuilder.Entity("cost_income_calculator.api.Models.Income", b =>
                {
                    b.HasOne("cost_income_calculator.api.User", "user")
                        .WithOne("Income")
                        .HasForeignKey("cost_income_calculator.api.Models.Income", "UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
